    ...
    <div class="head-top">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                    <div class="icon"> <i> <a href="https://www.facebook.com/UTMoldova"><img src="{{asset('icon/facebook.png')}}"></a></i> <i> <a href="https://twitter.com/utm_md"><img src="{{asset('icon/Twitter.png')}}"></a></i> </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
